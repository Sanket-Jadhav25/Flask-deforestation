...
def shrink_total(cordinates):
    ...
    unique_cordinates["horizontal_edge_coordinates"] = unique_cordinates[
                                                           "horizontal_edge_coordinates"] + shrink_horizontal_coordinates(
        horizontal_edge, horizontal_distance)
    unique_cordinates["vertical_edge_coordinates"] = unique_cordinates[
                                                         "vertical_edge_coordinates"] + shrink_vertical_coordinates(
        vertical_edge, vertical_distance)
...
def grid(cordinates):
    ...
    unique_cordinates["horizontal_edge_coordinates"] = unique_cordinates[
                                                           "horizontal_edge_coordinates"] + horizontal_coordinates(
        horizontal_edge, horizontal_distance)
    unique_cordinates["vertical_edge_coordinates"] = unique_cordinates[
                                                         "vertical_edge_coordinates"] + vertical_coordinates(
        vertical_edge, vertical_distance)
...
def find_file(name):
    return drive_service.files().list(q=f"name='{name}'", fields='nextPageToken, files(id, name)',
                                      pageToken=page_token).execute()
